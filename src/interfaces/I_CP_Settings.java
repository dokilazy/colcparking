...
public class I_CP_Settings {
	...
	public static class VRM {
		...
		public static By select_CameraName = By.xpath("//app-dropdown-camera/ng-select");
		public static By txt_Camera= By.xpath("//input[@formcontrolname= 'camera']");
		public static By txt_ExceptionDate = By.xpath("//input[@formcontrolname= 'exceptionDate']");
