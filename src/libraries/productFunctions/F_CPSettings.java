...
public class F_CPSettings {
	...
	// public static void (SeleniumBrowser Browser) {
	//
	// }
	...
	public static void inputExceptionDate(SeleniumBrowser Browser, String pValue) {
		Browser.enter(I_CP_Settings.VRM.txt_ExceptionDate, pValue);
	}
	...
	public static String addNewVRM(SeleniumBrowser Browser) {
		...
		inputExceptionDate(Browser, Functions.getCurrentDate(CPValueList.dateFormat.formatUS));
	...
	public static void clickAddCatalog(SeleniumBrowser Browser, String name) {
		WebElement editEle = Browser
				.captureInterface(By.xpath("//tree-node-content[contains(.,'" + name + "')]/button[1]/i"));
		editEle.click();
	}
	...
	public static void clickDeleteCatalog(SeleniumBrowser Browser, String name) {
		...
		editEle.click();
		Browser.clickJavascript(deleteCatEle);  // try 2nd time
	}
