...
public class F_GeneralVerification {
	 ...
	 *            Element to verify
	 * @param pElementName
	 *            Name of element to be displayed in error message if error occurs
	 * @param pResult
	 *            Result of test case
	 */
	 ...
	 *            Result of test case
	 */
	public static void verifyElementInvisible(SeleniumBrowser Browser, WebElement pElement, String pElementName,
			TCResult pResult) {
	 ...
	 *            Result of test case
	 */
	public static void verifyElementSelected(SeleniumBrowser Browser, WebElement pElement, String pElementName,
			TCResult pResult) {
	 ...
	 *            Result of test case
	 */
	public static void verifyElementNotSelected(SeleniumBrowser Browser, WebElement pElement, String pElementName,
			TCResult pResult) {
		if (pElement.isSelected()) {
			pResult.SetResult(false);
	 ...
	 *            Result of test case
	 */
	public static void verifyElementValue(SeleniumBrowser Browser, String pElementName, String pActualResult,
	 ...
	 *            Name of the element
	 * @param pBy
	 *            Mechanism of element that contains actual value needs to verify
	 * @param pExpectedResult
	 *            Expected value
	 * @param pResult
	 *            Result of test case
	 ...
	 * 
	 * @param cTitle
	 *            Control for dialog title
	 * @param eTitle
	 *            Expected dialog title
	 * @param cMessage
	 *            Control for dialog Message
	 * @param eMessage
	 *            Expected dialog Message
	 * @param pResult
	...
	public static void verifyPopupIsDisplayedCorrectly(SeleniumBrowser Browser, By cTitle, String eTitle, By cMessage,
		...
		F_GeneralVerification.verifyElementValue(Browser, "Popup title", Browser.captureInterface(cTitle).getText(),
				eTitle, pResult);
		F_GeneralVerification.verifyElementValue(Browser, "Popup message", Browser.captureInterface(cMessage).getText(),
				eMessage, pResult);
	 ...
	 * 
	 * @param pFirstValue
	 *            First Value to verify
	 * @param pSecondValue
	 *            Second Value to verify
	 * @param pResult
	 *            Result of test case
	 */
